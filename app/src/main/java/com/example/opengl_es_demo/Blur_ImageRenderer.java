...
public class Blur_ImageRenderer implements GLSurfaceView.Renderer {
...
//                                "vec3 vChangeColor = vec3(0.6f,0.4f,0.2f);\n" +
...
//                                "nColor/=13.0;\n"+
    ...
    public Blur_ImageRenderer(Context context) {
        mContext = context;
        try {
            mBitmap = BitmapFactory.decodeStream(mContext.getResources().getAssets().open("fengjing.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
